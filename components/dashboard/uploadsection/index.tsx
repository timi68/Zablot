					...
					<div className="form-group">
						...
						<div className="alternate-post">
							<div className="alternate-wrap">
								<div className="image-alternate upload-image post-image alternate">
									<svg
										className="svg"
										height="24px"
										viewBox="0 0 24 24"
								...
								<div className="video-alternate post-video alternate">
									<svg
										className="svg"
										height="24px"
										viewBox="0 0 24 24"
								...
								<div className="poll-alternative post-post alternate">
									<svg
										className="svg"
										height="24px"
										viewBox="0 0 24 24"
